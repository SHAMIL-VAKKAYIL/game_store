...
export function CreateLoadingComp() {
    return (
        <div>
            <div className="flex-col flex w-60  justify-center overflow-hidden rounded-lg p-2 animate-pulse">
                <div className="w-56 h-64 rounded-lg object-cover m-auto bg-gray-300 animate-pulse"></div>
